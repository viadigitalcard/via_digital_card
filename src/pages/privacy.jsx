    ...
    <div>
      ...
      <Box p="30px" bg={bgColor} color={textColor}>
        ...
        <Text>
          ...
          failure to protect your password’s confidentiality. You agree to
          immediately notify Via Creative Tech of any unauthorized activity that
          occurs on your account or any suspected breach of security including
          loss, theft, or unauthorized disclosure of your password. • If you
          create an account on Via Creative Tech, you represent that you are of
          legal age to form a binding contract, have the requisite authority to
          bind the other party to this Agreement and are not a person barred by
          any law from using the Website. You shall not use the Website if you
          are not legally competent to form a binding contract. • You agree to
          provide true, accurate, current and complete information about
          yourself in all required fields of the registration form. If any of
          your information changes, you agree to update your registration
          ...
          from using the Website. • You agree not to use or launch any automated
          system, including without limitation, “robots”, “spiders”, “scrapers”,
          or similar technological devices or programs. Notwithstanding the
          foregoing, Via Creative Tech grants the operators of public search
          engines permission to use spiders to copy materials from the Website
          for the sole purpose of creating publicly available searchable indices
          of the materials, but not caches or archives of such materials. Via
          Creative Tech reserves the right to revoke these exceptions either
          generally or in specific cases, in its sole discretion.
        </Text>
        <Text fontSize={"xl"} fontWeight="bold">
        ...
        <Text>
          ...
          not lawfully owned by you. You further agree and undertake to provide
          correct and valid credit card details to Via Creative Tech Website.
          Further the said information will be not be utilized and shared by Via
          Creative Tech with any of the third parties unless required by law,
        ...
        <Text>
          ...
          paragraph. Except in limited instances under authorized agreements, we
          do not reproduce or manufacture the products offered on our site, but
          rather we purchase or license products from third party suppliers that
          represent to us that they have sufficient rights to allow us to
          display and sell the products on the website. Upon receipt of any
          bona-fide claim of infringement, or upon becoming aware of any actual
          or alleged infringement by any other means, we will remove such actual
          or alleged infringing product(s) from the website and/or cease sales
          of the product(s) pending our investigation. If you believe that your
        ...
        <Text>
          ...
          access to the Website and any other viadigitalacard.in services. Cause
          ...
          (h) your actions that have caused or may cause any harm, damage or
          loss to the other Users or viadigitalcard.in
        </Text>
        <Text fontSize={"xl"} fontWeight="bold">
          Warranty Disclaimer
        </Text>
        <Text>
          ...
          THE FULLEST EXTENT PERMITTED BY LAW, VIA CREATIVE TECH, AND ANY
          PARENT, SUBSIDIARY, AFFILIATE, DIRECTOR, OFFICER, EMPLOYEE, LICENSOR,
          DISTRIBUTOR, SUPPLIER, AGENT, RESELLER, OWNER, OR OPERATOR OF VIA
          ...
          ACCESS TO AND USE OF THE WEBSITE, (III) ANY UNAUTHORIZED ACCESS TO OR
          ...
          OR FROM THE WEBSITE, (IV) ANY BUGS, VIRUSES, TROJAN HORSES, OR THE
          LIKE WHICH MAY BE TRANSMITTED TO OR THROUGH OUR WEBSITE BY ANY THIRD
          ...
          THE WEBSITE. VIA CREATIVE TECH DOES NOT WARRANT, ENDORSE, GUARANTEE,
          OR ASSUME RESPONSIBILITY FOR ANY HYPERLINKED WEBSITE OR OTHER
          PROMOTION, AND VIA CREATIVE TECH WILL NOT BE A PARTY TO OR IN ANY WAY
          ...
          CREATIVE TECH OR THROUGH OR FROM THE SERVICE SHALL CREATE ANY WARRANTY
          NOT EXPRESSLY STATED IN THE TERMS OF USE. AS WITH THE PURCHASE OF A
        ...
        <Text>
          ...
          THE FOREGOING RESTS ENTIRELY WITH YOU. The Website is controlled and
          offered by VIA CREATIVE TECH from its facilities in Mumbai, India. VIA
          CREATIVE TECH makes no representations that the Website is appropriate
        ...
        <Text>
          ...
          the Terms of Use at any given time. You should regularly review these
          Terms. In the event the modified Terms are not acceptable to you, you
          should discontinue using the service. However, if you continue to use
          the service, you agree to accept and abide by the modified Terms of
          Use.
        </Text>
        <Text fontSize={"xl"} fontWeight="bold">
          Contact Us
